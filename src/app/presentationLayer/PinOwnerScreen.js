        ...
        <SafeAreaView style={styles.background}>
            <View style={styles.container}>
                ...
                <View style={styles.containerTop}>
                    ...
                    <TouchableOpacity style={{marginStart:15}} onPress={handleDelete}>
                        <Image style={[styles.image, {width:25, height:25}]} fadeDuration={250} source={require("../../assets/bin.png")}/>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.containerEditBtn} onPress={handleEdit}>
                        <Image style={[styles.image, {width:25, height:25}]} fadeDuration={250} source={require("../../assets/edit.png")}/>
                        <Text style={{marginStart: 10, fontWeight:'bold', fontSize: 15, color: colors.white}}> Edit</Text>
                    </TouchableOpacity>
                </View>
