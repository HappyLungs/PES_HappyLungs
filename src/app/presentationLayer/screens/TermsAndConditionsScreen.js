		...
		<View style={styles.container}>
			...
			>
				...
				<Text style={styles.normalText}>
					...
					use of Happy Lungs's App.
				</Text>
				<Text style={styles.normalText}>
					By accessing this website we assume you accept these terms and
					conditions. Do not continue to use Happy Lungs if you do not agree to
					take all of the terms and conditions stated on this app.
				</Text>
				<Text style={styles.normalText}>
				...
				<Text style={styles.normalText}>
					Unless otherwise stated, Happy Lungs and/or its licensors own the
					intellectual property rights for all material on Happy Lungs. All
					intellectual property rights are reserved. You may access this from
					Happy Lungs for your own personal use subjected to restrictions set in
					these terms and conditions.
				</Text>
				<Text style={styles.normalText}>
					You must not: -Republish material from Happy Lungs -Sell, rent or
					sub-license material from Happy Lungs -Reproduce, duplicate or copy
					material from Happy Lungs -Redistribute content from Happy Lungs
				</Text>
				<Text style={styles.normalText}>
					Parts of this app offer an opportunity for users to post and exchange
					opinions and information in certain areas of the website. Happy Lungs
					does not filter, edit, publish or review Comments prior to their
					presence on the app. Comments do not reflect the views and opinions of
					Happy Lungs,its agents and/or affiliates. Comments reflect the views
					and opinions of the person who post their views and opinions. To the
					extent permitted by applicable laws, Happy Lungs shall not be liable
					...
					appearance of the Comments on this app.
				</Text>
				<Text style={styles.normalText}>
					Happy Lungs reserves the right to monitor all Comments and to remove
				...
				<Text style={styles.normalText}>
					You hereby grant Happy Lungs a non-exclusive license to use,
				...
				<Text style={styles.normalText}>
					...
					the hyperlink compensates the absence of Happy Lungs; and (d) the link
				...
				<Text style={styles.normalText}>
					...
					sending an e-mail to Happy Lungs. Please include your name, your
				...
				<Text style={styles.normalText}>
					No use of Happy Lungs's logo or other artwork will be allowed for
